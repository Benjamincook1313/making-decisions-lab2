...
family.forEach(item => console.log(item))
...
myFavoriteNumbers[6]? console.log('There are not enough elements in ths array'): someNum = myFavoriteNumbers[6]
...
listOfNumbers.forEach(num => {
  if(num % 3 === 0) console.log(`${num} is devisable by 3`)
})
...
letters.forEach(ltr => console.log(ltr))
...
switch(letterGrade){
  case letterGrade === 'A':
    ...
    break;
  case letterGrade === 'B':
    console.log('The student is doing will.')
    break
  case letterGrade === 'C':
